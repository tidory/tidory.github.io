<template lang="pug">
  #nav(:class="[show ? 'block' : 'hidden']" class="fixed box-border z-30 overflow-hidden bg-gray-300 top-0 w-64 h-full xl:block")
    div(class="overflow-hidden overflow-y-auto overflow-y-scroll h-full w-80 absolute")
