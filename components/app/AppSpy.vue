<template lang="pug">
  #spy
    ...
    div(:class="[show ? 'block' : 'hidden']" class="fixed p-4 right-4 top-16 bg-gray-500 rounded list-none text-left z-0 xl:w-44 xl:bg-transparent xl:backdrop-blur-0 xl:p-0 xl:absolute xl:top-0 xl:right-auto xl:ml-[calc(620px+110px)] xl:h-full xl:block")
