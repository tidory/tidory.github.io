...
**images** 폴더는 템플릿 또는 컴포넌트에 포함된 리소스들이 모여있는 파일이며, 추가적으로 템플릿 내부에서 작성한 **fixed** 속성이 사용되지 않은 **script** 태그의 집합인 **script.js**, **assets/app.js** 에서 포함한 에셋들의 집합인 **app.js** 가 있습니다.
...
템플릿에 있는 **fixed** 속성이 사용되지 않은 **style** 태그들의 집합 파일입니다.
