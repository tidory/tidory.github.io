...
**템플릿 별칭**을 설정합니다. 문자열로 지정을 해줄 수도 있고 함수형태로 사용할 수도 있습니다. [alias-pug-plugin](https://github.com/tidory/alias-pug-plugin) 이 사용되었습니다. 함수의 파라매터는 해당 별칭이 사용된 자원의 **파일 이름**입니다. 템플릿에서는 다음과 같이 적용됩니다.
