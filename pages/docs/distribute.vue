    ...
    article.paragraph
      ...
      pre
        code.lang-javascript
          | {{ deploy }}
      p #[b npm run deploy:github] 명령을 따로 만들고, 배포 순서에 따라 빌드를 하고, #[b push-dir] 을 먼저 하는 것으로 코드 저장소에 푸쉬한 다음, 티스토리 스킨에 적용시키도록 바꿔주면 코드 저장소와 스킨 코드를 동일하게 만들 수 있습니다.
      pre
        code.lang-javascript
          | {{ pushDir }}
      p 
      ...
      p 티도리 프레임워크가 아닌 #[b 다른 프로젝트]에 자신의 스킨 프로젝트를 직접 연동할 수 있도록 만들어 보고 싶을 수도 있습니다. 티도리 프레임워크에서 #[b 티스토리 서버와 통신]하는 부분(프리뷰, 배포, 저장)에는 필자가 작성한 특별한 인터페이스가 사용됩니다. 
      p #[a(href="https://github.com/tidory/tistory-skin") 티스토리 스킨 API] 가 있다면 연동이 완전히 불가능한 것은 아닙니다. 해당 API 는 티스토리 스킨에 대한 조작을 할 수 있습니다. #[b 티스토리 스킨 편집]에 있는 대부분의 기능(파일 및 스킨 추가, 삭제, 프리뷰, 스킨코드 변경 등)을 프로그래밍이 가능한 형태로 제공합니다.
      pre
        code.lang-javascript
          | {{ deployer }}
