...
app-page(:active="$store.state.menu.package.page")
  ...
  main.text(slot="text" role="text")
    ...
    article.paragraph
      ...
      p 티도리 패키지는 #[b NPM 패키지]로 #[b 취급]하고 패키지 매니저 또한 #[b npm] 을 사용합니다. 하지만 본질적으로 NPM 패키지라고 보기에는 무리가 있습니다. 따라서 패키지에는 이름에 제약을 걸어둡니다. 티도리 패키지는 #[b @tidory] 스코프 아래에 두는 것을 원칙으로 합니다. 또한 NPM 레지스트리에 #[b 공표(Publich)] 하는 일이 없도록 하십시오. 레지스트리는 #[b github] 를 사용하세요.
