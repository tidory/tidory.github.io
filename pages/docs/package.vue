...
app-page(:active="$store.state.menu.advanced.package.page")
  ...
  main.text(slot="text" role="text")
      ...
      p
        div.blockquote-type-3
          pre.
            ...
            ├── LICENSE
            └── README.md
      p 티도리 패키지의 기본 폴더구조이며 필수적인 것은 아닙니다. 하지만 프로젝트 템플릿에서 기본적으로 포함하는 템플릿은 #[b index.pug] 입니다. #[b index.pug] 는 패키지의 최상위 템플릿으로서 존재합니다. 기본 패키지 예제는 #[a(href="https://github.com/tidory/default-header") default-header] 예제를 참고해주세요.
    article.paragraph
      h2(id="@tidory") @tidory
    ...
    article.paragraph
      h2(id="package.json") package.json
      ...
      pre(data-label="package.json")
        code.lang-json {{ pkg }}
    article.paragraph
      h2(id="모듈과 패키지 종속") 모듈과 패키지 종속
      p 티도리 패키지가 다른 #[b NPM 패키지]나 #[b 티도리 패키지]에 종속할 수 있을까요?
      h3(id="뷰 & 리액트 컴포넌트") 뷰 & 리액트 컴포넌트
      p 티도리 프레임워크는 #[b 뷰 컴포넌트]와 #[b 리액트 컴포넌트] 해석이 가능합니다. 티도리 패키지 내부에서 컴포넌트를 당연히 포함시킬 수 있습니다. 기존에 #[b app.js] 에서 작성했던 것을 그대로 #[b index.js] 에 작성하면 됩니다. 컴포넌트가 포함된 패키지는 #[a(href="https://github.com/tidory/default-sidebar") default-sidebar] 예제를 참고해주세요.
