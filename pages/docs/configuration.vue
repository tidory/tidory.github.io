...
app-page(:active="$store.state.menu.configuration.page")
  ...
  main.text(slot="text" role="text")
    article.paragraph
      ...
      p #[b 컴포넌트 자원 공개경로]를 설정합니다. 컴포넌트와 같이 자바스크립트를 통해 이미지와 같은 리소스를 사용하면 티스토리에 의해 경로 자동으로 변환되지 않아 올바르게 로드할 수 없습니다. 따라서 #[b 공개 경로(Public Path)]를 설정해주어야 합니다. 해당 주소는 블로그마다 다릅니다.   
