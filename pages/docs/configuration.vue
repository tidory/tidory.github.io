...
app-page(:active="$store.state.menu.configuration.page")
  ...
  main.text(slot="text" role="text")
    article.paragraph
      ...
      h3(id="url") url
      p #[b 티스토리 블로그 주소]입니다. 세션과 마찬가지로 #[b 프리뷰]하거나 #[b 배포]하기 위해 사용됩니다. 자신이 가지고 있는 블로그여야 합니다.
      ...
      p #[b 컴포넌트 자원 공개경로]를 설정합니다. 컴포넌트와 같이 자바스크립트를 통해 이미지와 같은 리소스를 사용하면 티스토리에 의해 경로가 자동으로 변환되지 않아 올바르게 로드될 수 없습니다. 따라서 #[b 공개 경로(Public Path)]를 설정해주어야 합니다. 해당 주소는 블로그마다 다릅니다. 공개 경로는 다음과 같이 생겼습니다.
      pre
        code.lang-plain
