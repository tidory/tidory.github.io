...
app-page(:active="$store.state.menu.prologue.intro.page")
  ...
  main.text(slot="text" role="text")
    article.paragraph
      ...
      h3(id="개발 단계") 개발 단계
      p #[b 개발 단계]에서는 #[b skin.html, style.css] 파일을 작성하는 것이 가장 중요한 일입니다.
      ...
      h3(id="테스트 단계") 테스트 단계
      p #[b 테스트 단계]에서는 작성된 #[b skin.html, style.css] 파일을 #[b 스킨편집]에 복사 붙여넣기 하거나 테스트 블로그를 통해 스킨의 모습을 미리 확인해보는 것을 말하며 이 과정은 스킨을 최종 배포하기 바로 전까지 반복됩니다.
      blockquote.blockquote-type-1
        ol(type="1")
          li
      ...
      h3(id="스킨적용 및 배포 단계") 스킨적용 및 배포 단계
      p #[b 스킨적용 및 배포 단계]에서는 티스토리 스킨을 자신의 블로그에 적용시키거나 스킨 저장소에 저장하는 단계입니다. 블로그에 글을 써서 유저에게 배포하는 단계는 제외됩니다.
      blockquote.blockquote-type-1
        ol(type="1")
          li
